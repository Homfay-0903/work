        ...
        <div class="iframe-template">
            ...
            <template v-else>
                <iframe
                    ...
                    ref="modelView"
                    class="iframe1"
                    :src="`../../../static/model-iframe/pillow/index.html?t=${new Date().getTime()}`"
...
export default {
    ...
    created: function() {
        ...
        this.MODEL_STORE.onRotateShape = idx => {
            ...
            // this.$eventBus.$emit('changeShapeIndex', idx)
        }
    ...
    methods: {
        ...
        loadShapeModel() {
            this.MODEL_STORE.options = this.options
            setTimeout(() => {
                document.getElementById(this.frameId).contentWindow.loadShapeModel()
            }, 500)
        },
        ...
        loadHeadNeckModel() {
            this.MODEL_STORE.options = this.options
            document.getElementById(this.frameId).contentWindow.loadHeadNeckModel()
        },

...
export default {
    ...
    methods: {
        ...
        //     this.form.name = name
        //     if (name === '颈椎前屈') {
        //         this.form.desc = '颈椎向前屈的最大活动角度'
        //     } else if (name === '颈椎后伸') {
        //         this.form.desc = '颈椎向后伸的最大活动角度'
        //     } else if (name === '颈椎左侧屈') {
        //         this.form.desc = '颈椎向左侧倾斜的最大活动角度'
        //     } else if (name === '颈椎右侧屈') {
        //         this.form.desc = '颈椎向右侧倾斜的最大活动角度'
        //     } else if (name === '颈椎左旋转') {
        //         this.form.desc = '颈椎向左旋转的最大活动角度'
        //     } else if (name === '颈椎右旋转') {
        //         this.form.desc = '颈椎向右旋转的最大活动角度'
        //     }

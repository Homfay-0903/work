<!--
 * @Description: 脊柱专项报告，青少年专项报告的专属表头
 * @Author: zhaoqianqian
 * @Date: 2022-06-30 18:04:56
 * @LastEditors: liutq
 * @LastEditTime: 2026-01-12 20:46:57
-->
<template>
    <!-- 头部信息 -->
    <div class="header-info">
        <div class="nickname">
            <div class="nick-name">
                <!-- 昵称 -->
                <span>{{ memberInfo.nickName ? memberInfo.nickName : memberInfo.mobile }}</span>
            ...
            <div :class="['detail-info', isDeviceReport ? 'isDeviceReport' : '']">

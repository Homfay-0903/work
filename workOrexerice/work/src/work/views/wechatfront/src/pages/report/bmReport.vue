 ...
 * @LastEditTime: 2025-06-19 16:55:16
 * @LastEditors: DonWang wangwenqiu@suanier.com
 * @LastEditTime: 2024-08-27 17:51:20
 -->
<template>
    <div>
        <div class="bm-report" v-cloak>
            ...
            <div :class="isTangCenBei?'right-part1':'right-part' ">
                ...
                <!-- 细胞内外液 -->
                <div class="analysis-table thead-line" :style="marginBottomCalculation" v-if="ICW && (ICW.l !== 0 || ICW.h !== 0) && showCell">
                    <table border="1" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr>
                                <th></th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td colspan="4">
                                    <mass-progress v-if="ICW" :val="ICW.v" :low="ICW.l" :hight="ICW.h"></mass-progress>
                                </td>
                                <td>
                                    <span v-if="ICW" class="limits">[{{ toDecimal(ICW.l, 1) }}~{{ toDecimal(ICW.h, 1) }}]</span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <mass-progress v-if="ECW" :val="ECW.v" :low="ECW.l" :hight="ECW.h"></mass-progress>
                                </td>
                                <td>
                                    <span v-if="ECW" class="limits">[{{ toDecimal(ECW.l, 1) }}~{{ toDecimal(ECW.h, 1) }}]</span>
                                </td>
                                <td>
...
<script>
import { bodyAdjustInfo, bmSegInfo, bmGirthContrastInfo, bodyState, bmMassContrastInfo } from '@/assets/js/apolloGql.js'

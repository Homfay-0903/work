                    ...
                    <ElForm ref="formRef" :model="formData" :rules="rules" class="w-[90%]" @submit.prevent="handleLock">
                        <ElFormItem prop="password">
                            <ElInput v-model="formData.password" type="password"
                                :placeholder="$t('lockScreen.lock.inputPlaceholder')" :show-password="true"
                                ref="lockInputRef" class="w-full mt-9" @keyup.enter="handleLock">
                                <template #suffix>
                ...
                <ElForm ref="unlockFormRef" :model="unlockForm" :rules="rules" class="w-full !px-2.5"
                    ...
                    <ElFormItem prop="password">
                        <ElInput v-model="unlockForm.password" type="password"
                            :placeholder="$t('lockScreen.unlock.inputPlaceholder')" :show-password="true"
                    ...
                    <div class="w-full text-center">
                        <ElButton text class="mt-2.5 !text-g-600 hover:!text-theme hover:!bg-transparent"
                            @click="toLogin">
